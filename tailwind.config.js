...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage:{
        "custom-image-1" : 'url("../landing-page/assets/desktop/image-footer.jpg")',
        "custom-image-2" : 'url("../landing-page/assets/tablet/image-footer.jpg")',
        "custom-image-3" : 'url("../landing-page/assets/mobile/image-footer.jpg")',
      }
    },
  },
  plugins: [],
